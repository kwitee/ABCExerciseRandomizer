...
class TestScoreGenerator:
    ...
    @pytest.mark.parametrize("bar_length,number_of_bars,output",
                             [
                                 (BarLength.four, 1, "X:1\n"
                                                     "T:1 - Random score\n"
                                                     "M:4/4\n"
                                                     "L:1/4\n"
                                                     "Q:1/4 = 50\n"
    ...
    def test_generate_score(self, bar_length, number_of_bars, output):
        score_generator = ScoreGenerator(self.__create_bar_generator_mock(), bar_length, number_of_bars)
        assert score_generator.generate_score() == output

    @pytest.mark.parametrize("bar_length,number_of_bars,number_of_scores,output",
                             [
                                 (BarLength.four, 3, 1, "X:1\n"
                                                        "T:1 - Random score\n"
                                                        "M:4/4\n"
                                                        "L:1/4\n"
                                                        "Q:1/4 = 50\n"
    ...
    def test_generate_scores(self, bar_length, number_of_bars, number_of_scores, output):
        score_generator = ScoreGenerator(self.__create_bar_generator_mock(), bar_length, number_of_bars)
